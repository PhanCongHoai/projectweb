...
import { FaHome, FaChartLine, FaShoppingCart, FaBox, FaUsers, FaChartBar, FaCog } from "react-icons/fa";
import "./Admin.css";
...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
    const menuItems = [
        ...
        { icon: <FaUsers />, label: "Khách hàng", key: "customers" },
    ...
    return (
        <div className="sidebar">
            <div className="sidebar-header">
                <div className="sidebar-brand-icon"><FaHome /></div>
